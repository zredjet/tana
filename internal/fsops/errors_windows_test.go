...
func TestClassifyErrnoWindows(t *testing.T) {
	...
	cases := []errnoCase{
		...
		// 応答しないネットワークの場所・準備のできていないドライブ（filer VU7）
		{windows.ERROR_BAD_NETPATH, KindUnreachable},
		{windows.ERROR_NETNAME_DELETED, KindUnreachable},
		{windows.ERROR_BAD_NET_NAME, KindUnreachable},
		{windows.ERROR_REM_NOT_LIST, KindUnreachable},
		{windows.ERROR_UNEXP_NET_ERR, KindUnreachable},
		{windows.ERROR_BAD_NET_RESP, KindUnreachable},
		{windows.ERROR_NETWORK_BUSY, KindUnreachable},
		{windows.ERROR_DEV_NOT_EXIST, KindUnreachable},
		{windows.ERROR_SEM_TIMEOUT, KindUnreachable},
		{windows.ERROR_NETWORK_UNREACHABLE, KindUnreachable},
		{windows.ERROR_HOST_UNREACHABLE, KindUnreachable},
		{windows.ERROR_CONNECTION_REFUSED, KindUnreachable},
		{windows.ERROR_NO_NET_OR_BAD_PATH, KindUnreachable},
		{windows.ERROR_NOT_CONNECTED, KindUnreachable},
		{windows.ERROR_NOT_READY, KindUnreachable},
		// 表にない番号
